...
namespace Lumi
{
    internal static class Kernel32
    {
        ...
        public static string GetWindowsPhysicalPath( string path )
        {
            ...
            Kernel32.GetShortPathName( path, builder, builder.Capacity );

            path = builder.ToString();

            var result = Kernel32.GetLongPathName( path, builder, builder.Capacity );
            ...
            if( result > 0 )
            {
                ...
                result = Kernel32.GetLongPathName( path, builder, builder.Capacity );
                builder[0] = Char.ToLower( builder[0] );
                return builder.ToString( 0, (int) result );
            }
